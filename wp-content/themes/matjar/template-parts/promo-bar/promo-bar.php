 ...
 *
 * @author 	ThemeJR
 * @package matjar/template-parts/promo-bar
 * @since 1.0
 */
...
<div class="matjar-promo-bar position-<?php echo esc_attr( $promo_position );?> position-type-<?php echo esc_attr( $promo_position_type );?>" data-position_type="<?php echo esc_attr( $promo_position_type );?>" data-position="<?php echo esc_attr( $promo_position );?>">
	<div class="container">
