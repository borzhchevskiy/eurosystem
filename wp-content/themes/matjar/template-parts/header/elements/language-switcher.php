...
if( ! matjar_get_option( 'header-language-switcher', 1 ) ) {
	return; 
}
...
if ( class_exists('SitePress') ) {
	...
	$languages = matjar_polylang_language_switcher();
	
	if( ! empty( $languages ) ) :?>		
		<div class="language-switcher  polylang-language">
			<?php if( matjar_get_option('header-language-switcher-style', 'dropdown' ) == 'dropdown'): ?>
				<ul class="matjar-dropdown <?php echo 'country-'.matjar_get_option( 'header-language-switcher-view', 'name' );?>">
	...
	if( ! empty( $languages ) ) : ?>
		<div class="language-switcher  translatepress-language">
			...
			<?php else:?>
				<ul class="matjar-languages <?php echo 'country-'.matjar_get_option( 'header-language-switcher-view', 'name' );?>">
					<?php foreach( $languages as $lang => $data ):?>
