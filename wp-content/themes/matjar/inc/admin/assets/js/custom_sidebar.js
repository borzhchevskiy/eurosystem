(function ($, window) {
	...
	MATJAR_SIDEBAR.prototype = {
		...
		createRemoveButton: function () {
            this.widgetArea.find('.sidebar-matjar-custom').append('<span class="custom-sidebar-delete dashicons-trash"></span>');
        },
