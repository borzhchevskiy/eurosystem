...
if ( function_exists( 'YITH_YWRAQ_Frontend' ) ) {
	...
	if( ! function_exists( 'matjar_yith_quote_button_single_page' ) ) {
		function matjar_yith_quote_button_single_page(){
			global $product;
		...
		add_action( 'woocommerce_before_single_product', 'matjar_yith_quote_button_single_page');
	}
}