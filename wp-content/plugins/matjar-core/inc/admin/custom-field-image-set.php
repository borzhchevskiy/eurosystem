...
if ( ! class_exists( 'RWMB_Image_Set_Field' ) )
{
	class RWMB_Image_Set_Field extends RWMB_Choice_Field
	{
		...
		{
			wp_enqueue_style( 'rwmb-custom-image-set', MATJAR_CORE_URL . '/assets/css/custom-field-image-set.css', array(), RWMB_VER );
			wp_enqueue_script( 'rwmb-custom-image-set', MATJAR_CORE_URL . '/assets/js/custom-field-image-set.js', array(), RWMB_VER, true );
		}
		/**
		 * Get field HTML
		 *
