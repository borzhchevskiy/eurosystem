<?php
/*
Element: Product Grid carousel
*/
use Elementor\Controls_Manager;

class Matjar_Elementor_Product_Grid_Carousel extends Matjar_Elementor_Widget_Base {
	/**
	...
	public function get_name() {
        return 'matjar_products_grid_carousel';
    }

	/**
     * Get widget title.
     *
     * Retrieve Product Grid carousel widget title.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_title() {
        return esc_html__( 'Products Grid Or Carousel', 'matjar-core' );
    }

    /**
     * Get widget icon.
     *
     * Retrieve Product Grid carousel widget icon.
     *
     * @since 1.0.0
     * @access public
     *
	...
	public function get_keywords() {
		return [ 'woocommerce', 'product', 'grid','carousel' ];
	}
	
	/**
     * Register Product Grid carousel widget controls.
     *
    ...
    protected function register_controls() {
		...
		$this->add_control(
			'products_countdown',
			[
				'label' 	=> esc_html__( 'Show Count Down', 'matjar-core' ),
	...
	protected function render() {
		...
		$settings['id'] 	= matjar_uniqid( 'matjar-grid-slider-' );
		$class				= array( 'matjar-element', 'woocommerce' );
		...
		$settings['attribute'] 	= wp_json_encode( array_intersect_key( $settings,matjar_default_product_args() ) );		
		
		matjar_get_pl_templates( 'elements-widgets/woo-products-grid-carousel', $settings );
	}
}

$widgets_manager->register(new Matjar_Elementor_Product_Grid_Carousel());