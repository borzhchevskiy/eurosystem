...
class Matjar_Elementor_WCVendors extends Matjar_Elementor_Widget_Base {
	/**
	...
	public function get_name() {
        return 'matjar_wc_vendors';
    }

	/**
     * Get widget title.
     *
     * Retrieve WC Vendors widget title.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_title() {
        return esc_html__( 'WC Vendors', 'matjar-core' );
    }

    /**
     * Get widget icon.
     *
     * Retrieve WC Vendors widget icon.
     *
     * @since 1.0.0
     * @access public
     *
	...
	/**
     * Register WC Vendors widget controls.
     *
	...
	protected function render() {
		...
		$settings['id'] 		= matjar_uniqid('matjar-wc-vendors-');
		$class					= array( 'matjar-element', 'matjar-wc-vendors', 'matjar-vendors-'.$style );
		...
		matjar_get_pl_templates( 'elements-widgets/wc-vendors/'.$style, $settings );
	}
}

$widgets_manager->register(new Matjar_Elementor_WCVendors());