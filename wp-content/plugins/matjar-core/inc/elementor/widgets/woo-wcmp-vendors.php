...
class Matjar_Elementor_WCMPVendors extends Matjar_Elementor_Widget_Base {
	/**
	...
	public function get_name() {
        return 'matjar_wcmp_vendors';
    }

	/**
     * Get widget title.
     *
     * Retrieve WCMP Vendors widget title.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_title() {
        return esc_html__( 'WCMP Vendors', 'matjar-core' );
    }

    /**
     * Get widget icon.
     *
     * Retrieve WCMP Vendors widget icon.
     *
     * @since 1.0.0
     * @access public
     *
	...
	/**
     * Register WCMP Vendors widget controls.
     *
	...
	protected function render() {
		...
		$settings['id'] 		= matjar_uniqid('matjar-wcmp-vendors-');
		$class					= array( 'matjar-element', 'matjar-wcmp-vendors', 'matjar-vendors-'.$style );
		...
		matjar_get_pl_templates( 'elements-widgets/wcmp-vendors/'.$style, $settings );
	}
}

$widgets_manager->register(new Matjar_Elementor_WCMPVendors());