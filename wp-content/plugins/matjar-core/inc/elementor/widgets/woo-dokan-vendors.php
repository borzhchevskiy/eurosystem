<?php
/**
 * Element: Dokan Vendors
 */
use Elementor\Controls_Manager;

class Matjar_Elementor_DokanVendors extends Matjar_Elementor_Widget_Base {
	/**
	...
	public function get_name() {
        return 'matjar_dokan_vendors';
    }

	/**
     * Get widget title.
     *
     * Retrieve Dokan Vendors widget title.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_title() {
        return esc_html__( 'Dokan Vendors', 'matjar-core' );
    }

    /**
     * Get widget icon.
     *
     * Retrieve Dokan Vendors widget icon.
     *
     * @since 1.0.0
     * @access public
     *
	...
	/**
     * Register Dokan Vendors widget controls.
     *
    ...
    protected function register_controls() {
		...
		$this->add_control(
            ...
            [
                ...
                'type' 		=> Controls_Manager::SELECT,
                'options' 	=> [
					'meta_value'	=> esc_html__( 'Store Name', 'matjar-core' ),
	...
	protected function render() {
		...
		$settings['id'] 		= matjar_uniqid( 'matjar-dokan-vendors-' );
		$class					= array( 'matjar-element', 'matjar-dokan-vendors', 'matjar-vendors-'.$style );
		...
		if( $orderby == 'meta_value' ){
			$user_args['meta_key'] 		= 'dokan_store_name';
		}
		$user_args['fields'] 	= 'ID';
		...
		matjar_get_pl_templates( 'elements-widgets/dokan-vendors/'.$style, $settings );
	}
}

$widgets_manager->register(new Matjar_Elementor_DokanVendors());