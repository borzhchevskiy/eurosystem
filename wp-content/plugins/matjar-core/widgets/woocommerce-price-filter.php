 ...
 * @see   WP_Widget
 */
class Matjar_Price_Filter_List_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops  = array(
			'classname'   => 'matjar_widget_price_filter_list widget_layered_nav',
			'description' => esc_html__( 'Shows a price filter list in a widget which lets you narrow down the list of shown products when viewing product categories.', 'matjar-core' ),
		);
		$control_ops = array( 'width' => 400, 'height' => 350 );
		parent::__construct( 'matjar-price-filter-list', esc_html__( 'Matjar: Price Filter List', 'matjar-core' ), $widget_ops, $control_ops );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 */
		$text = apply_filters( 'matjar_widget_price_filter_list', $widget_text, $instance, $this );
		...
		if ( $price_list ) {
			...
			foreach ( $price_list as $price ) {
				...
				if ( $price_attr ) {
					...
					$link = $this->matjar_get_page_base_url();
					if ( $min_price == $min_price_actived ) {
						if ( $params ) {
							$link .= '?' . $params;
						}
	 ...
	 * @return string
	 */
	public function matjar_get_page_base_url() {
	...
	public function form( $instance ) {
		...
		?>
		<p><label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e( 'Title:', 'matjar-core' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		</p>

		<p><label for="<?php echo esc_attr($this->get_field_id( 'text' )); ?>"><?php esc_html_e( 'Content:', 'matjar-core' ); ?></label>
...
300|400'; ?></textarea>
		...
		<p><?php esc_html_e( 'Enter the price by format: min_price|max_price. Divide price list with linebreaks (Enter). Example:', 'matjar-core' ); ?></p>
		<p><?php esc_html_e( '0|100', 'matjar-core' ); ?><br><?php esc_html_e( '100|200', 'matjar-core' ); ?><br><?php esc_html_e( '200|300', 'matjar-core' ); ?>
			<br><?php esc_html_e( '300|400', 'matjar-core' ); ?></p>
		<?php
	}
}
