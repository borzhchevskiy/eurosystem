<?php 
/**
 * Categories and Sub Categories Vertcal Template
 */
?>
								...
								<div class="category-image">
									...
									if ( ! empty( $catalog_img ) ) {
										...
										<a href="<?php echo esc_url($cate_link);?>">
											<?php echo matjar_get_image_html( $thumbnail_id, $image_size, '', $attribute ); ?>
										</a>
									<?php }else{ ?>
									...
									<?php if( ! empty( $inner_subcats ) ){?>
										<ul class="sub-categories">
											...
											<li class="show-all-cate">
												<a href="<?php echo esc_url( $cate_link );?>"><?php echo esc_html__('Show All', 'matjar-core');?></a>
											</li>
										</ul>
									<?php }?>
								</div>
